  ...
  defaults = {
    ...
    mappings = {
      i = {
        ...
        -- TODO! Make a way to read file contents into current file.
        -- ["<C-r>"] = previewers.vim_buffer_cat,
        ["<C-r>"] = previewers.new_buffer_previewer,
        -- previewers.buffer_previewer_maker({filepath}, {bufnr}, {opts}) *previewers.buffer_previewer_maker()*

        -- this seemed close maybe??
        -- lua require('telescope.config').values.grep_previewer()
